...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-auto min-h-[620px] md:min-h-[660px] w-full flex-col overflow-hidden bg-neutral-950 text-white outline-none select-none overflow-x-hidden py-12 md:py-16",
        className
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
        ...
        <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left min-h-[144px] justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h2 className="text-3xl font-bold tracking-tight md:text-4xl text-white uppercase font-display">
                  {activeItem.title}
                </h2>
                {activeItem.description && (
                  <p className="max-w-md text-neutral-400 font-sans text-sm leading-relaxed">
                    {activeItem.description}
                  </p>
                )}
              </motion.div>
